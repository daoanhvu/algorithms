...
export class HttpService extends HttpClient {
  ...
  get(url: string, options?: any): any {
    return this.request('get', url, extend({}, options));
  }

  post(url: string, body: any, options?: any): any {
    return this.request('post', url, extend({}, options, {
      body: body,
    }));
  }

  put(url: string, body: any, options?: any): any {
    return this.request('put', url, extend({}, options, {
      body: body,
    }));
  }

  delete(url: string, options?: any): any {
    return this.request('delete', url, extend({}, options));
  }

  patch(url: string, body: any, options?: any): any {
    return this.request('patch', url, extend({}, options, {
      body: body,
    }));
  }
