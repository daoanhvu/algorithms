...
public class JPAConfiguration {
	...
	@Bean
	@Primary
	@ConfigurationProperties("datasource.hsql")
...
//		return jpaVendorAdapter;
	...
	private Properties jpaProperties() {
        ...
        properties.put("hibernate.dialect", environment.getRequiredProperty("datasource.hsql.hibernate.dialect"));
        properties.put("hibernate.hbm2ddl.auto", environment.getRequiredProperty("datasource.hsql.hibernate.hbm2ddl.method"));
        properties.put("hibernate.show_sql", environment.getRequiredProperty("datasource.hsql.hibernate.show_sql"));
        properties.put("hibernate.format_sql", environment.getRequiredProperty("datasource.hsql.hibernate.format_sql"));
        if(StringUtils.isNotEmpty(environment.getRequiredProperty("datasource.hsql.defaultSchema"))){
            properties.put("hibernate.default_schema", environment.getRequiredProperty("datasource.hsql.defaultSchema"));
        }
        return properties;
	}
